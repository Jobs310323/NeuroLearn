...
/**
 * Цвет системного окружения PWA: строка панелей браузера и фон при запуске.
 * Единственное место, где цвет нельзя взять из токена — тег `meta` читается
 * до применения CSS. Значение обязано совпадать с `--color-void` в
 * `globals.css`, иначе при старте приложения видна полоса другого оттенка.
 */
